...
class AgentRegistrationController extends Controller
{
    public function showRegistrationForm()
    {
        ...
        return response()
            ->view('agent-registration', compact('agent'))
    ...
    public function registerStep1(Request $request)
    {
        ...
        try {
            ...
            // 1. Check if an active USER account already exists for this email with agent role
    ...
    public function completeRegistration(Request $request)
    {
        ...
        try {
            ...
            if ($razorpayOrder) {
                ...
                return response()->json([
                    'success' => true,
                    'message' => 'Registration completed successfully! (Test Mode - No Gateway)',
                    'test_payment' => true,
                    'agent_id' => $agent->id
                ]);
            }
