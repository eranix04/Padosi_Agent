...
<div class="family_banner_outer home-page-banner position-relative">
    ...
    <section class="top-text-section position-relative">
            <h2 class="banner-top-title">Find <span class="trusted">Trusted & Verified</span> Insurance Experts in your  <span class="padosi">Padosi</span></h2>         
        </section>
                            ...
                            <div class="col-lg-6 col-md-12 col-sm-12 col-12 h-banner-left-img responive-banner-img1">
                                <div class="banner_content" data-aos="fade-up">
                                    ...
                                    <div class="button_wrapper">
                                        <a href="{{ url('/find-agents') }}" class="text-decoration-none all_button get_started">Find My PadosiAgent</a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6 col-md-12 col-sm-12 col-12 h-banner-left-img responive-banner-img2">
                                <div class="banner_content" data-aos="fade-up">
                                    ...
                                    <div class="button_wrapper">
                                        ...
                                        <a href="{{ url('/find-agents') }}" class="text-decoration-none all_button get_started">Find Claims Expert</a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6 col-md-12 col-sm-12 col-12 h-banner-left-img responive-banner-img3">
                                <div class="banner_content" data-aos="fade-up">
                                    ...
                                    <div class="button_wrapper">
                                        ...
                                        <a href="{{ url('/find-agents') }}" class="text-decoration-none all_button get_started">Find Insurance Expert</a>
                                    </div>
                                </div>
                            </div>
