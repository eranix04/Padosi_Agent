    ...
    <div class="full-width container">
        ...
        <main class="main-content">
            <!-- Pricing Plans Section -->
                ...
                <p class="pricing-subtitle"><strong>Pre-Launch Discount Offer</strong></p>
                <p class="pricing-subtitle"><strong>Once in a lifetime offer!</strong></p>
                <p class="pricing-subtitle">Get started at special introductory prices.</p>
                </div>
    ...
    <script>
        ...
        function selectPlan(planType) {
            ...
            if (planType === 'basic') {
                ...
                // Update selected plan summary
                document.getElementById('selectedPlanName').textContent = "Professional's Plan";
...
// Custom slow scroll
setTimeout(() => {
    const proPlan = document.querySelector('.plan-card.professional');
    if (proPlan && window.innerWidth <= 768) {
        const target = proPlan.offsetTop;
