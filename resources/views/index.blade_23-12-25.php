            ...
            <div class="content-wrapper">
                ...
                <div class="cta-buttons">
                    <button class="btn btn-secondary" data-bs-toggle="modal" data-bs-target="#BecomeCustomer">
                        ...
                        <span>Say Thanks To Your Padosi<p style="font-size: 10px;">For everyone - 5 Lakh Prize Pool</p></span>
    ...
    <input type="hidden" name="insurance_companies" id="insuranceCompaniesInput">
                                  ...
                                  <div class="flex-box">
                                        <div class="form-group">
                                            ...
                                            <input name="experience_range" type="number" min="0" max="60" oninput="if(this.value.length>2) this.value=this.value.slice(0,2)">
    ...
    <div class="popup-content" style="background: white; border-radius: 12px; max-width: 460px; width: 90%; margin: 20px auto; padding: 20px; position: relative; max-height: 90vh; overflow-y: auto;">
        ...
        <div class="steps-section" style="margin: 25px 0;">
            ...
            <div class="step-box" id="step1Box" style="background: #f0f9ff; border: 2px solid #0ea5e9; border-radius: 10px; padding: 15px; margin-bottom: 15px; transition: all 0.3s ease;">
                <div class="step-header" style="display: flex; align-items: center; gap: 10px; margin-bottom: 10px;">
                    ...
                    <h4 style="margin: 0; color: #0c4a6e; font-size: 16px;">Follow Our Social Media</h4>
                </div>
                <p style="margin: 0 0 15px 0; color: #475569; font-size: 14px;">
                    Follow at least one social media account to proceed to step 2
                </p>
                ...
                <div class="step-status" id="step1Status" style="margin-top: 10px; font-size: 12px; color: #666; display: none;">
                    ✓ Step 1 completed! Now proceed to Step 2
                </div>
            </div>
            ...
            <div class="step-box" id="step2Box" style="background: #f8fafc; border: 2px dashed #cbd5e1; border-radius: 10px; padding: 15px; opacity: 0.6; transition: all 0.3s ease;">
                <div class="step-header" style="display: flex; align-items: center; gap: 10px; margin-bottom: 10px;">
                    ...
                    <h4 style="margin: 0; color: #64748b; font-size: 16px;">Share with Friends</h4>
                ...
                <p style="margin: 0 0 15px 0; color: #94a3b8; font-size: 14px;">
                    {{-- Share on WhatsApp to complete registration and earn bonus entries --}}
                    Boom! Share now to make your contest entry official! 💥
               </p>
                ...
                <div class="step-status" id="step2Status" style="margin-top: 10px; font-size: 12px; color: #666; display: none;">
                    ✓ Step 2 completed! Participation fully confirmed
                </div>
            </div>
        </div>
        ...
        <div class="progress-indicator" style="margin: 20px 0; text-align: center;">
            ...
            <p style="font-size: 12px; color: #64748b; margin: 0;">
                <span id="currentStep">Step 1 of 2</span> • <span id="completionStatus">0% Complete</span>
            </p>
        </div>
...
<script>
// Your working function with step box updates
function enableWhatsAppButton() {
    ...
    step1Status.innerHTML = '✓ Step 1 completed! Now proceed to Step 2';
    ...
    // DON'T update progress text to 100% yet - only after Step 2 is completed
    document.getElementById('currentStep').textContent = 'Step 2 of 2';
    document.getElementById('completionStatus').textContent = '50% Complete'; // Changed from 100%
...
function completeStep2() {
    ...
    // NOW update to 100% after Step 2 is completed
