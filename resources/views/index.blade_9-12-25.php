        ...
        <main class="main-content">
            <div class="content-wrapper">
                ...
                <div class="title-section">
                    ...
                    <p class="subtitle">Beacuse behind every <span><strong>Safe & Happy Home</strong></span>, There's <span><b>Padosi</b></span></p>
                                            ...
                                            <div class="portfolio-inputs">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="life_insurance"
                                                        placeholder="Life Insurance %" min="0" max="100" value="0">
                                                </div>
                                                <div class="form-group">
                                                    <label>Health</label>
                                                    <input type="number" name="health_insurance"
                                                        placeholder="Health Insurance %" min="0" max="100" value="0">
                                                </div>
                                                <div class="form-group">
                                                    <label>Motor</label>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="general_insurance"
                                                        placeholder="Non-motor & SME %" min="0" max="100" value="0">
                                                </div>
...
{{-- <div class="early-bird-box-2">
    ...
    <div class="plan-selection-section">
        <p class="text-accent plan-selection-title">💎 Choose Your Plan • Lifetime Benefits 💎</p>
        
        <div class="plan-options-container">
            <!-- Basic Plan Option -->
            <div class="plan-option basic-plan" data-plan="basic" onclick="selectPlan('basic')">
                ...
                <div class="plan-features">
                    <div class="feature-item">✓ Organic & Service Leads</div>
                    <div class="feature-item">✓ Permanent Webpage</div>
                    <div class="feature-item">✓ 5 Image Gallery</div>
            ...
            <div class="plan-option professional-plan active" data-plan="professional" onclick="selectPlan('professional')">
                ...
                <div class="plan-features">
                    <div class="feature-item">✓ Priority Leads</div>
                    <div class="feature-item">✓ 10 Image Gallery</div>
                    <div class="feature-item">✓ Advanced Analytics</div>
                    <div class="feature-item">✓ Trusted Agent Badge</div>
                    <div class="feature-item">✓ Full Client Tools</div>
                </div>
                <div class="plan-selected-indicator">
                    <div class="selection-circle"></div>
                </div>
    ...
    <!-- Rest of your existing content remains same -->
    <div class="gst-text-muted-foreground">
        <span>GST (18%)</span>
        <span class="font-bold">₹359</span>
    </div>
...
<div class="early-bird-box-2">
    ...
    <div class="plan-selection-section">
        ...
        <div class="plan-options-container">
            ...
            <div class="plan-option basic-plan" data-plan="basic" onclick="selectPlan('basic')">
                ...
                <div class="plan-selected-indicator">
                    <div class="selection-circle"></div>
                    <span class="selection-text">Select Plan</span>
                </div>
            </div>
            ...
            <div class="plan-option professional-plan active" data-plan="professional" onclick="selectPlan('professional')">
                ...
                <div class="plan-features">
                    ...
                    <div class="feature-item">✓ Trusted Agent Badge</div>
                    <div class="feature-item">✓ Full Client Tools</div>
                    <div class="feature-item">✓ Paid Lead Inquiries</div>
                </div>
                <div class="plan-selected-indicator">
                    <div class="selection-circle"></div>
                    <span class="selection-text">Selected Plan</span>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="dynamic-price-section">
        <div class="price-comparison">
            <div class="original-price">
                <span class="original-label">Original Price:</span>
                <span class="original-amount crossed-price" id="originalPrice">₹2,999</span>
            </div>
            
            <div class="discount-badge">
                <span class="discount-icon">🎁</span>
                <span class="discount-percent" id="discountPercent">33% OFF</span>
            </div>
            
            <div class="offer-price">
                <span class="offer-label">Offer Price:</span>
                <span class="offer-amount" id="offerPrice">₹1,999</span>
            </div>
        </div>
        ...
        <div class="registration-fee">
            ...
            <div class="text-right">
                <div class="price-details">
                    <span class="original-fee crossed-price">₹2,999</span>
                    <span class="discount-badge-small">33% OFF</span>
                    <span class="final-fee" id="registrationFeeDisplay">₹1,999</span>
                </div>
            </div>
        </div>
        ...
        <div class="gst-text-muted-foreground">
            <span>GST (18%)</span>
            <span class="font-bold" id="gstAmount">₹359</span>
        </div>
        
        <div class="total-amount-section">
            <div class="from-transparent via-primary to-transparent"></div>
            <div class="total-amount">
                <span class="text-foreground">Total Amount Payable</span>
                <span class="text-accent text-4xl" id="totalAmount">₹2,358</span>
            </div>
            <div class="total-savings">
                <span class="savings-icon">💰</span>
                <span class="savings-text">You save <span id="totalSavings">₹641</span> with this offer</span>
            </div>
        </div>
        ...
        <div class="payment-notice">
            <div class="notice-item">
                ...
                <span class="notice-text">Limited Time Pre-Launch Offer</span>
            </div>
            <div class="notice-item">
                <span class="notice-icon">🔄</span>
                <span class="notice-text">Price increases to <span class="price-increase">₹4,999</span> after 500 registrations</span>
            </div>
        </div>
    </div>
                ...
                <form id="participantForm" data-no-google-auth="true">
                    ...
                    <!-- Insurance Question -->
                                ...
                                <div class="form-group full-width">
                                    ...
                                    <input type="text" name="thank_my_Padosi" placeholder="Please Enter Your PadosiAgent Name" >
                                    <span class="error-message" id="thank_my_Padosi_error"></span>
                                </div>

                                <div class="form-group full-width">
                                    <label>for</label>
                                    <textarea name="thank_my_Padosi_for" placeholder="Please share how your PadosiAgent has been helpful to you..."> </textarea>
            ...
            <div class="follow-section">
                ...
                <div class="social-follow-buttons">
                    ...
                    <a href="https://www.facebook.com/people/PadosiAgent/61570016781365/" target="_blank" class="social-follow-btn facebook-btn">
                        <svg width="18" height="" viewBox="0 0 24 24" fill="white">
                            <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                        </svg>
                        Facebook
                    </a>                    
...
// 1. Update your existing planData object (if you have one)
const planData = {
    basic: {
        name: 'Basic Plan',
        offerPrice: 499,
...
// SIMPLIFIED - Single selection function that works for both
function selectPlan(plan) {
    // 1. Remove active class from ALL plan options (for your HTML structure)
    document.querySelectorAll('.plan-option').forEach(option => {
        option.classList.remove('active');
    });
    
    // 2. Add active class to selected plan
    const selectedElement = document.querySelector(`.${plan}-plan`);
    if (selectedElement) {
    ...
    // 4. Update selection text if you have it
    const selectionTexts = document.querySelectorAll('.selection-text');
    selectionTexts.forEach(text => {
        text.textContent = 'Select Plan';
    });
    
    const activeSelectionText = selectedElement?.querySelector('.selection-text');
    if (activeSelectionText) {
        activeSelectionText.textContent = 'Selected Plan';
    }
}
...
function updatePricingDisplay(plan) {
    ...
    const gst = offerPrice * 0.18;
    const totalAmount = offerPrice + gst;
    const totalSavings = discount + (gst * (discount/originalPrice));
    ...
    updateElement('originalPrice', `₹${originalPrice.toLocaleString()}`);
    updateElement('discountPercent', `${discountPercent}% OFF`);
    updateElement('offerPrice', `₹${offerPrice.toLocaleString()}`);
    updateElement('registrationFeeDisplay', `₹${offerPrice}`);
    updateElement('gstAmount', `₹${Math.round(gst)}`);
    updateElement('totalAmount', `₹${Math.round(totalAmount)}`);
    updateElement('totalSavings', `₹${Math.round(totalSavings)}`);
    
    // Update registration fee display
    const registrationFeeElement = document.querySelector('.registration-fee .bg-destructive-right');
    if (registrationFeeElement) {
        registrationFeeElement.textContent = `₹${offerPrice}`;
    }
    
    // Update crossed-out original price
    const originalFee = document.querySelector('.original-fee');
    if (originalFee) originalFee.textContent = `₹${originalPrice}`;
    ...
    // Update total amount display (for your existing structure)
    const totalElement = document.querySelector('.total-amount .text-accent');
    if (totalElement) {
        totalElement.textContent = `₹${Math.round(totalAmount)}`;
    }
    
    // Update GST display (for your existing structure)
    const gstElement = document.querySelector('.gst-text-muted-foreground span:last-child');
    if (gstElement) {
        gstElement.textContent = `₹${Math.round(gst)}`;
    }
    
    // Update price increase notice
    const priceIncreaseElement = document.querySelector('.price-increase');
    if (priceIncreaseElement) {
        priceIncreaseElement.textContent = plan === 'basic' ? '₹2,999' : '₹4,999';
    }
}
...
function getSelectedPlan() {
    ...
    return activePlan ? activePlan.getAttribute('data-plan') : 'professional';
}
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Set professional as active
    const professionalPlan = document.querySelector('.professional-plan');
    if (professionalPlan) {
        professionalPlan.classList.add('active');
    }
    
    // Update pricing
    updatePricingDisplay('professional');
});
