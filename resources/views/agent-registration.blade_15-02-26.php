                    ...
                    <div class="modal-step active" data-step="1">
                        ...
                        <form id="agentForm1" action="{{ route('agent.register.step1') }}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="fullname" placeholder="Enter your full name" required="" value="{{ $agent->fullname ?? '' }}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="email-input-container">
                                            <input type="email" name="email" id="regEmail" placeholder="your.email@example.com"
                                                required="" onblur="validateEmailOnBlur(this)" value="{{ $agent->email ?? '' }}" {{ isset($agent) ? 'readonly' : '' }}>
                                            <button type="button" id="sendOtpBtn" class="verify-btn" onclick="sendOTP()" style="{{ isset($agent) ? 'display: none;' : '' }}">Verify</button>
                                        </div>
                                        ...
                                        <div id="emailVerifiedBadge" class="verified-badge" style="{{ isset($agent) ? 'display: flex;' : '' }}">
...
<script>
    ...
    var isEmailVerified = {{ isset($agent) ? 'true' : 'false' }};
