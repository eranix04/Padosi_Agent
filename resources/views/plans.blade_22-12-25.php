        ...
        <main class="main-content">
            <!-- Pricing Plans Section -->
                ...
                <p class="pricing-subtitle">
                    <strong>Pre-Launch Discount Offer: Once in a lifetime offer!</strong> 
                ...
                <div class="plans-container">
                    ...
                    <div class="plan-card basic">
                        <div class="recommended-badge">PRE-LAUNCH</div>
                        <div class="plan-header">
                            <div class="plan-name">Starter's Plan</div>
                            <div class="original-price"><b>₹2,359/-</b></div>
                            <div class="plan-price">₹589/-<span> 1<sup>st</sup> Year Only</span></div>
                    ...
                    <div class="plan-card professional">
                        ...
                        <div class="plan-header">
                            ...
                            <div class="original-price"><b>₹8,258/-</b></div>
                            <div class="plan-price">₹2,359/-<span> 1<sup>st</sup> Year Only</span></div>
                        ...
                        <div class="features-list">
                            ...
                            <div class="feature-category">
                                ...
                                <div class="feature-item highlighted mb-1">
                                    <div class="feature-name"><i class="fas fa-award"></i>  Trusted Agent Badge</div>
                                    <div class="feature-value">Yes</div>
                                </div>
                                <div class="feature-item highlighted mb-1">
                                    <div class="feature-name"><i class="fas fa-chart-line"></i> Profile Analytics</div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (window.innerWidth <= 768) {
        // Get elements
        const basicPlan = document.querySelector('.plan-card.basic');
        const professionalPlan = document.querySelector('.plan-card.professional');
        const plansContainer = document.querySelector('.plans-container');
        
        if (!basicPlan || !professionalPlan || !plansContainer) {
            console.error('Required plan elements not found');
            return;
        }
        
        // Create toggle container
        const toggleContainer = document.createElement('div');
        toggleContainer.className = 'plan-toggle-container';
        
        // Create toggle switch
        const toggleSwitch = document.createElement('div');
        toggleSwitch.className = 'plan-toggle-switch';
        
        // Create toggle buttons
        const basicToggle = document.createElement('button');
        basicToggle.type = 'button';
        basicToggle.className = 'plan-toggle-btn basic-toggle ';
        basicToggle.textContent = 'Starter Plan';
        
        const professionalToggle = document.createElement('button');
        professionalToggle.type = 'button';
        professionalToggle.className = 'plan-toggle-btn professional-toggle active';
        professionalToggle.textContent = 'Professional';
        
        // Add toggle buttons to switch
        toggleSwitch.appendChild(basicToggle);
        toggleSwitch.appendChild(professionalToggle);
        
        // Add toggle switch to container
        toggleContainer.appendChild(toggleSwitch);
        
        // Insert toggle before plans container
        plansContainer.parentNode.insertBefore(toggleContainer, plansContainer);
        
        // Initially show Basic plan, hide Professional
        // basicPlan.classList.add('active');
        // professionalPlan.classList.remove('active');

        // Initially show Professional, hide Basic plan
        ...
        window.addEventListener('resize', function() {
            if (window.innerWidth > 768) {
                ...
                professionalPlan.style.display = 'block';
            } else {
                // Add toggle on mobile if not present
                if (!document.querySelector('.plan-toggle-container')) {
                    plansContainer.parentNode.insertBefore(toggleContainer, plansContainer);
                    // Reset to Professional plan (since it's default in your code)
